...
Dopo aver depositato il corpus sul repositorio, il TIGR verrà inserito in una piattaforma di consultazione e analisi online. 

In parallelo al lavoro sui dati, l'esperienza di raccolta del corpus è stata condivisa tramite il [blog](https://sharetigr.usi.ch/it/notizie-eventi/blog), a più voci e in due lingue (italiano e inglese).

## Sul progetto InfinIta: perché è stato creato il corpus TIGR?

### Le domande di ricerca 

Il corpus TIGR è nato per cercare di rispondere sostanzialmente a tre domande che riguardano la categorizzazione delle fonti di informazione nell'italiano parlato: 
...
Prima che fosse possibile cominciare a registrare le interazioni, ogni partecipante registrata/o ha espresso il proprio consenso all'uso dei dati dopo essere messa/o a conoscenza degli scopi dell'indagine e delle modalità di diffusione dei dati.
...
Prevedere fin dall'inizio la pubblicazione dei dati (video) ha richiesto una riflessione su due tematiche principali:
...
Vedi esempio video al minuto 1:07:06 fino a 1:09:56. CREA COLLEGAMENTO IPERTESTUALE AL VIDEO
...
Esempio a 1:10:42 fino a 01:11:48 CREA COLLEGAMENTO IPERTESTUALE AL VIDEO
...
A transcription technique was adopted that privileged the alignment of segment boundaries with boundaries of overlapping speech, such as to facilitate the revision of transcripts in ELAN and the manual layout of complex sequences with overlapping speech. Proper names were pseudonymized.  
